            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                    <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                        <span class="block">SAVE SMART </span>
                        <span class="block text-primary-600">Welcome</span>
                    </h1>
                    <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        Prenez le contrôle de vos finances personnelles<br> avec SaveSmart. Suivez vos dépenses, fixez des objectifs d'épargne et atteignez la liberté financière.
                    </p>
                    <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                        <div class="rounded-md shadow">
                            <a href="/register" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-black bg-green-600 hover:bg-primary-700 md:py-4 md:text-lg md:px-10">
                                Commencer gratuitement
                            </a>
                        </div>
                        <div class="lg:absolute lg:inset-y-0 rounded-lg lg:right-0 lg:w-1/2  mt-1 m-5 mr-10">
    <img class="h-full w-full object-cover" src="OIP.jpg" alt="SaveSmart illustration">
</div>
...
<div id="addGoalModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <h3 class="text-lg font-bold mb-4">Ajouter un Objectif d'Épargne</h3>
        <form action="{{ route('goals.store') }}" method="POST">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2">Montant actuel (€)</label>
                <input type="number" name="current_amount" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" class="px-4 py-2 bg-primary-600 text-white rounded">Ajouter</button>
            </div>
        </form>
    </div>
</div>
